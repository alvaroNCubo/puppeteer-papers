...
| `WhatTheRecordCostsLab` | §8 | the record's price, Release, n=10 after a discarded warm-up, median [min..max]: **554** bytes for definition + first exercise, **~112** per additional (exact); replay **5.0 ms** at 100 and **15.9 ms** at 1,000 exercises; **~2,430**/s through the plane vs **~533,000**/s direct — **~220x**, two figures being what repeated invocations support |
