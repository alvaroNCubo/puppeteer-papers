...
appliance sized to a modest small-or-medium business --- a 4 GB / 300 GB
box hosting an accounting system, a clinic management system, a
hardware-store inventory and point-of-sale system, or a
professional-services back office. The difference between these shapes
is operational variation over the same architecture. What bounds the
appliance case is the customer's domain --- how much data, how many
users, how heavy the workload --- not anything the architecture
introduces.
