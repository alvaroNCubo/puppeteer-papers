...
construct presented here. Stonebraker (2005) observes that the
relational database has become a one-size-fits-all hammer applied to
use-cases for which it is structurally ill-suited, and predicts the
...
Distributed Transactions} (2007) and \emph{Immutability Changes
Everything} (2015) similarly observe the proliferation as a structural
consequence. The present paper names what these critiques document
piecewise --- the unifying property of compensation --- and
operationalizes the discrimination.
...
Stonebraker, M. (2005). One size fits all: A concept whose time has come
and gone. \emph{Proceedings of the 21st International Conference on Data
Engineering (ICDE)}.
