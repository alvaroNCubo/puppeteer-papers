...
| 524 | `time` global registered as `Temporal` instance | §6.4 |
| 561-568 | `Cue` mode push-callback registration via `AddRecordWrittenCallback` | §6.1 |
| 572-573 | `includeExposeData=true` during rehydration | §6.7 |
